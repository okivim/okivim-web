...
[Learn more](https://docs.rs/cc/latest/cc/#compile-time-requirements)
...
Required for projects that rely on it.

[prettierd](https://github.com/fsouza/prettierd) is recommended for better performance (*daemon-based*).
If you prefer, you can use [prettier](https://prettier.io/).


<Tabs groupId="formatter">
  <TabItem value="prettierd" label="Prettierd">
    ``` bash
    npm install -g @fsouza/prettierd
    ```
  </TabItem>
  <TabItem value="prettier" label="Prettier">
    ``` bash
