...
##### 1- Required nvim-treesitter-cli: [instructions](https://github.com/tree-sitter/tree-sitter/blob/master/crates/cli/README.md)

##### 2- Required a C compiler: [more info](https://docs.rs/cc/latest/cc/#compile-time-requirements)
